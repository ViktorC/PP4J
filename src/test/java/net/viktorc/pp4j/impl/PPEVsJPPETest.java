...
public class PPEVsJPPETest {
	...
	/**
	 * Executes the performance test according to the specified arguments on a Java process pool using 
	 * JNI to invoke the native test method.
	 * 
	 ...
	 * @return The time it took to execute the specified number of submissions with the specified 
	 * execution length in nanoseconds.
	...
	/**
	 * Executes the performance test according to the specified arguments on a Java process pool using 
	 * JNA to invoke the native test method.
	 * 
	 * @param minSize The minimum sizes of the two pools.
	 * @param maxSize The maximum sizes of the two pools.
	 * @param reserveSize The reserve sizes of the two pools.
