...
public class StandardProcessPoolTest {
	...
	public void test02() throws Exception {
		...
		exceptionRule.expect(IllegalArgumentException.class);
		getPool(0, 0, 0, 0, false, false, false, false);
	}
	@Test
	public void test03() throws Exception {
		System.out.println(System.lineSeparator() + "Test 3");
		exceptionRule.expect(IllegalArgumentException.class);
		getPool(10, 5, 0, 0, false, false, false, false);
	}
	@Test
	public void test04() throws Exception {
		System.out.println(System.lineSeparator() + "Test 4");
		exceptionRule.expect(IllegalArgumentException.class);
		getPool(10, 12, -1, 0, false, false, false, false);
	}
	@Test
	public void test05() throws Exception {
		System.out.println(System.lineSeparator() + "Test 5");
		exceptionRule.expect(IllegalArgumentException.class);
		getPool(10, 12, 15, 0, false, false, false, false);
	}
	@Test
