...
/**
 * A simple sub-class of the {@link net.viktorc.pspp.AbstractCommand} abstract class that relies on lambda functions to 
 * implement the {@link net.viktorc.pspp.AbstractCommand#onOutput(String, boolean) onOutput} method and assumes that the 
