...
public class ProcessPools {
	 ...
	 * {@link net.viktorc.pp4j.impl.StandardProcessPool#StandardProcessPool(ProcessManagerFactory, int, int, int, long, Logger)}.
	 * 
	 ...
	 * {@link #newCustomProcessPool(ProcessManagerFactory, int, int, int, long, Logger)} with <code>keepAliveTime</code> set to 
	 * <code>0</code>.
	 * 
	 * @param managerFactory  A {@link net.viktorc.pp4j.api.ProcessManagerFactory} instance that is used to build 
	 * {@link net.viktorc.pp4j.api.ProcessManager} instances that manage the processes' life cycle in the pool.
	 ...
	 */
	public static ProcessPool newCustomProcessPool(ProcessManagerFactory managerFactory, int minPoolSize, int maxPoolSize,
			int reserveSize, Logger logger) throws InterruptedException {
		return newCustomProcessPool(managerFactory, minPoolSize, maxPoolSize, reserveSize, 0, logger);
	}
	/**
	 * Returns a pool of processes. The initial size of the pool is the greater of the minimum pool size and the reserve size. 
	 * This method blocks until the initial number of processes started up. The size of the pool is dynamically adjusted based 
	 * on the pool parameters and the rate of incoming submissions. It is a convenience method for calling the method
	 * {@link #newCustomProcessPool(ProcessManagerFactory, int, int, int, long, Logger)} with <code>logger</code> set to 
	 * <code>null</code>.
	 * 
	 * @param managerFactory  A {@link net.viktorc.pp4j.api.ProcessManagerFactory} instance that is used to build 
	 * {@link net.viktorc.pp4j.api.ProcessManager} instances that manage the processes' life cycle in the pool.
	 ...
	 * {@link #newCustomProcessPool(ProcessManagerFactory, int, int, int, long, Logger)} with <code>minPoolSize</code> and 
	...
	public static ProcessPool newFixedProcessPool(ProcessManagerFactory managerFactory, int size, long keepAliveTime,
		...
		return newCustomProcessPool(managerFactory, size, size, 0, keepAliveTime, logger);
	}
	/**
	 * Returns a pool of a fixed number of processes. It is a convenience method for calling the method
	 * {@link #newFixedProcessPool(ProcessManagerFactory, int, long, Logger)} with <code>keepAliveTime</code> set to 
	 ...
	 * @throws InterruptedException If the thread is interrupted while it is waiting for the processes to start up.
	 */
	public static ProcessPool newFixedProcessPool(ProcessManagerFactory managerFactory, int size, Logger logger)
			throws InterruptedException {
		return newFixedProcessPool(managerFactory, size, logger);
	}
	/**
	 * Returns a pool of a fixed number of processes. It is a convenience method for calling the method
	 * {@link #newFixedProcessPool(ProcessManagerFactory, int, long, Logger)} with <code>logger</code> set to <code>null
	...
	public static ProcessPool newFixedProcessPool(ProcessManagerFactory managerFactory, int size, long keepAliveTime)
			throws InterruptedException {
		return newFixedProcessPool(managerFactory, size, keepAliveTime, null);
	}
	/**
	 ...
	 * {@link #newCustomProcessPool(ProcessManagerFactory, int, int, int, long, Logger)} with <code>0</code> as the <code>
	...
	public static ProcessPool newCachedProcessPool(ProcessManagerFactory managerFactory, long keepAliveTime,
			Logger logger) throws InterruptedException {
		return newCustomProcessPool(managerFactory, 0, Integer.MAX_VALUE, 0, keepAliveTime, logger);
	}
	/**
	 * Returns a pool of processes that grows in size as required. It is a convenience method for calling 
	 * {@link #newCachedProcessPool(ProcessManagerFactory, long, Logger)} with <code>0</code> as the <code>keepAliveTime
	 ...
	 * @throws InterruptedException If the thread is interrupted while it is waiting for the processes to start up.
	 */
	public static ProcessPool newCachedProcessPool(ProcessManagerFactory managerFactory, Logger logger)
			throws InterruptedException {
		return newCachedProcessPool(managerFactory, 0, logger);
	}
	/**
	 * Returns a pool of processes that grows in size as required. It is a convenience method for calling 
	 * {@link #newCachedProcessPool(ProcessManagerFactory, long, Logger)} with<code>logger</code> set to <code>null
	...
	public static ProcessPool newCachedProcessPool(ProcessManagerFactory managerFactory, long keepAliveTime)
			throws InterruptedException {
		return newCachedProcessPool(managerFactory, keepAliveTime, null);
	}
	/**
	 ...
	 * {@link #newFixedProcessPool(ProcessManagerFactory, int, long, Logger)} with <code>1</code> as the <code>size</code>.
	 * 
	 * @param managerFactory  A {@link net.viktorc.pp4j.api.ProcessManagerFactory} instance that is used to build 
	 * {@link net.viktorc.pp4j.api.ProcessManager} instances that manage the processes' life cycle in the pool.
	 * @param keepAliveTime The number of milliseconds after which idle processes are terminated. If it is <code>0</code> 
	...
	public static ProcessPool newSingleProcessPool(ProcessManagerFactory managerFactory, long keepAliveTime,
			Logger logger) throws InterruptedException {
		return newFixedProcessPool(managerFactory, 1, keepAliveTime, logger);
	}
	/**
	 * Returns a fixed size pool holding a single process. It is a convenience method for calling the method
	 * {@link #newSingleProcessPool(ProcessManagerFactory, long, Logger)} with <code>0</code> as the <code>keepAliveTime
	 * </code>.
	 * 
	 * @param managerFactory  A {@link net.viktorc.pp4j.api.ProcessManagerFactory} instance that is used to build 
	 * {@link net.viktorc.pp4j.api.ProcessManager} instances that manage the processes' life cycle in the pool.
	 ...
	 * @throws InterruptedException If the thread is interrupted while it is waiting for the processes to start up.
	 */
	public static ProcessPool newSingleProcessPool(ProcessManagerFactory managerFactory, Logger logger)
			throws InterruptedException {
		return newSingleProcessPool(managerFactory, 0, logger);
	}
	/**
	 * Returns a fixed size pool holding a single process. It is a convenience method for calling the method
	 * {@link #newSingleProcessPool(ProcessManagerFactory, long, Logger)} with <code>null</code> as the <code>logger
	 * </code>.
	 * 
	 * @param managerFactory  A {@link net.viktorc.pp4j.api.ProcessManagerFactory} instance that is used to build 
	 * {@link net.viktorc.pp4j.api.ProcessManager} instances that manage the processes' life cycle in the pool.
	...
	public static ProcessPool newSingleProcessPool(ProcessManagerFactory managerFactory, long keepAliveTime)
			throws InterruptedException {
		return newSingleProcessPool(managerFactory, keepAliveTime, null);
	}
	/**
