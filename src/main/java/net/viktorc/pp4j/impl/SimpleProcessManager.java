 ...
 * process is immediately started up as soon as it is running (without having to wait for a certain output denoting that the 
 * process is ready), it has the process forcibly killed every time it needs to be terminated due to exceeding the 
