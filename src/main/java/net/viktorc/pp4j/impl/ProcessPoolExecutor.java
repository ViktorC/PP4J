...
public class ProcessPoolExecutor implements ProcessExecutorService {
	...
	/**
	 * Starts a new process by borrowing a {@link net.viktorc.pp4j.impl.ProcessPoolExecutor.InternalProcessExecutor} 
	...
	/**
	 * A sub-class of {@link net.viktorc.pp4j.impl.AbstractProcessExecutor} that utilizes an additional thread to 
	 * listen to the submission queue of the process pool and take submissions for executions.
	 * 
	 * @author Viktor Csomor
	 *
	 */
	 ...
	 * {@link net.viktorc.pp4j.impl.ProcessPoolExecutor.InternalProcessExecutor} instances.
	 * 
	 * @author Viktor Csomor
	 *
	 */
	private class InternalProcessExecutorObjectPool extends GenericObjectPool<InternalProcessExecutor> {
		 ...
		 * {@link net.viktorc.pp4j.impl.ProcessPoolExecutor.InternalProcessExecutor} instances. The pool 
	 ...
	 * logging the uncaught exceptions if the enclosing {@link net.viktorc.pp4j.impl.ProcessPoolExecutor} 
	 ...
	 * {@link net.viktorc.pp4j.impl.ProcessPoolExecutor.InternalProcessExecutor} instances. It utilizes an 
	...
	private class InternalProcessExecutorThreadPool extends ThreadPoolExecutor {
		 ...
		 * {@link net.viktorc.pp4j.impl.ProcessPoolExecutor.InternalProcessExecutor} instances. If there are 
