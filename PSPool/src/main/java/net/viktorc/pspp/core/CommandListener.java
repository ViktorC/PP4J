 ...
 * {@link #ProcessManager} instance when the {@link #ProcessManager.executeCommand(String, CommandListener) sendCommand} 
...
public interface CommandListener {
	 ...
	 * command. The {@link #ProcessManager} instance will not accept new commands until the processing of the 
	...
	/**
	 * A method called once the command has been written to the process' standard in.
	 */
	default void onSubmitted() { }
	/**
	 * A method called once the post-processing activities associated with the command has been completed.
	 */
